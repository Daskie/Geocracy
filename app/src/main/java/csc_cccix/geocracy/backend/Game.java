...
import csc_cccix.geocracy.FrontToBack;
import csc_cccix.geocracy.Util;
import csc_cccix.geocracy.backend.space.SpaceRenderer;
import csc_cccix.geocracy.backend.world.World;
...
public class Game {
    ...
    //public csc_cccix.geocracy.game.Notifications Notifications;
    ...
    private Vec2i tapDownPoint;
    private Vec2i tapUpPoint;
...
//  //      UI.updateCurrentPlayerFragment();
    ...
    private void processMessages() {
        Message msg = FrontToBack.receive();
        while (msg != null) {
            msg.run();
            msg = FrontToBack.receive();
        }
    }
